                    ...
                    <TableBody>
                        {user.map((row, index) => (
                            ...
                            >
                                ...
                                <TableCell align="center">{row.status ? (<Button align="center" variant='contained' color='success' onClick={() => { updateUser(row._id) }}>Unblock</Button>) : (<Button align="center" variant='contained' color='error' onClick={() => { updateUser(row._id) }}>Block</Button>)}</TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                </Table>
